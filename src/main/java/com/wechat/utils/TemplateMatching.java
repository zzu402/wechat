...
public class TemplateMatching {
    ...
    public static void main(String[] args) throws Exception {
        ...
        oldStyle("F://test//s3.png","F://test//templete.png");
//       newStyle("F://test//source.png","F://test//templete.png");

    }

    public static void newStyle(String sourcePath,String templetePath){
        ...
        Mat template = imread(templetePath,CV_LOAD_IMAGE_GRAYSCALE);//int = 0
    ...
    public static void oldStyle(String sourcePath,String templetePath){
        //get color source image to draw red rect on later
        IplImage srcColor = cvLoadImage(sourcePath);
        ...
        IplImage tmp = cvLoadImage(templetePath, 0);
        ...
        // Matched
        // Region
        ImageUtils.cron(maxLoc.x(),maxLoc.y(),tmp.width(),tmp.height(),sourcePath,"F://test//result.png");
